...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #second layer softmax, but here score is only linear
    scores = h1.dot(W2) + b2
    
    #scores_exp = np.exp(scores)
    #scores = scores_exp[y] / np.sum(scores_exp)
  ...
  def predict(self, X):
    ...
    #convert to predicted labels, don't need use softmax function here
